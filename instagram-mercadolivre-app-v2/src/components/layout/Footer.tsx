...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-cinza-elemento-dark text-texto-base-light dark:text-texto-base-dark border-t border-gray-200 dark:border-cinza-fundo-dark py-8 mt-8">
